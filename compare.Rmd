...
```{r}
resamps <- resamples(list(pls = pls.dv, glmnet = glmnet.dv, nsc = nsc.dv, mars = mars.dv, svm = svm.dv, svmL = svmL.dv, nnet = nnet.dv, rfset = rf.set, rfdv = rf.dv, rf2set = rf2.set, rf2dv = rf2.dv, c50data = c50.data, c50set = c50.set, c50dv = c50.dv, xgb = xgb.dv, xgbL = xgbL.dv, gbmset = gbm.set, gbmdv = gbm.dv))
